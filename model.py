...
class A3TGCN_(torch.nn.Module):
    ...
    def forward(
        ...
        """
        H_accum = 0
        #Si può inferire da solo il numero di period, x.shape
        #ogni riga è un frame?
...
class A3TGCN2_(torch.nn.Module):
...
class TemporalGNN(torch.nn.Module):
    def __init__(self, node_features, periods):
        ...
        self.tgnn = A3TGCN(in_channels=node_features,
                           out_channels=32,periods=periods)
        # Equals single-shot prediction
        #output invece di periods*3 lo mettiamo 1 
